...
I have created the such that it can be deployed on an AWS EC2 instance. So keep in mind that while creating the Dockerfile, it should be Linux compatible as Windows files can cause deployment failures.
